            ...
            <div class="col-sm-9">
                ...
                if (!empty($product)) {
                    foreach ($product->getData('cart') as $item) :
                        ...
                        if (!empty($cart)) { // Check if cart data is not empty
                                ...
                                <div class="row border-top py-3 mt-3">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div class="qty d-flex pt-2">
                                            ...
                                            <form method="post">
                                                <input type="hidden" value="<?php echo $item['item_id'] ?? 0; ?>" name="item_id">
                                                <button type="submit" name="wishlist-submit" class="btn font-Roboto text-danger">Save for Later</button>
                                            </form>
                                        </div>
                                        <!-- !product qty -->
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        <h5 class="font-Roboto font-size-20">Subtotal (<?php echo isset($subTotal) ? count($subTotal) : 0; ?> items):&nbsp;
